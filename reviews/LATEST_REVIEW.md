...
| C-016 | `modes-*.svg` | CBC error propagation | SP 800-38A App. D, quoted | **Corrected** — "cascading" was wrong |
...
| --- | --- | --- | --- | --- | --- |
| `modes-ctr-gcm-cbc.svg` | Was not — two wrong claims | Was not — no scope line, no caption anywhere on the page | Re-run, byte-identical | Neutral comparison | **Corrected**: CBC spread, GCM nonce condition, scope line with sources added |
